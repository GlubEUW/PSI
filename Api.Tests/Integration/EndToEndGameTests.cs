...
public class EndToEndGameTests
{
    ...
    public async Task CompleteGameFlow_TwoPlayers_TicTacToe()
    {
        ...
        await lobbyService.JoinTournament(code, player1);
        await lobbyService.JoinTournament(code, player2);
    ...
    public async Task LobbyService_JoinAndLeave_Players()
    {
        ...
        var join1 = await lobbyService.JoinTournament(code, player1);
        var join2 = await lobbyService.JoinTournament(code, player2);
